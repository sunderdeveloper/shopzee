...
import ProductShimmer from "@/components/Shimmer/ProductCard";
...
const ProductDetail = () => {
  ...
  return (
    <>
      <div className="max-w-10/12 lg:max-w-8/12 md:8/12 mx-auto w-full flex flex-wrap items-center gap-6 justify-center mt-10">
        <div>
          <Image
        ...
        <div className="w-full lg:w-6/12 md:10/12">
          ...
          <div className="flex items-center gap-4 my-4">
            <div className="flex items-center gap-4 py-2 px-4 border border-gray-500 rounded-sm w-fit text-sm">
              <span className="text-lg cursor-pointer" onClick={() => decreaseItem()}>-</span> {itemNum}{" "}
              <span className="text-lg cursor-pointer" onClick={() => increaseItem()}>+</span>
            </div>
            <div>
              <button className="bg-black text-white py-3 px-6 rounded-sm uppercase text-sm cursor-pointer">
                add to cart
              </button>
            </div>
          </div>
          <div className="py-2 px-4 text-md text-gray-600 uppercase rounded-sm border border-gray-500 w-fit">
            sku: {product.sku}
          </div>
        </div>
      </div>
